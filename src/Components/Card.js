...
const Card = ({
  ...
  return (
    <div className="border-2 border-first-color dark:border-first-night-color md:shadow-first-color md:shadow-md bg-seventh-color dark:bg-first-night-color flex flex-col justify-start card-size md:rounded-3xl sm:rounded-3xl zoomEfect ">
