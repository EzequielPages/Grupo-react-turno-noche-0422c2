        ...
        <div className="mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4 bg-seventh-color dark:bg-third-night-color">
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-8">
                ...
                <div className="sm:ml-0">
                    <h2 className="text-base font-semibold leading-4 text-fifth-color">COMPANY</h2>
                    ...
                    <p className="hover:text-fifth-color dark:hover:text-fifth-color text-base leading-4 mt-6 dark:text-seventh-color cursor-pointer">Pricing</p>
                    <p className="hover:text-fifth-color dark:hover:text-fifth-color text-base leading-4 mt-6 dark:text-seventh-color cursor-pointer">About Us</p>
                    <p className="hover:text-fifth-color dark:hover:text-fifth-color text-base leading-4 mt-6 dark:text-seventh-color cursor-pointer">Contact us</p>
                ...
                <div>
                    <h2 className="text-base font-semibold leading-4 text-fifth-color">SUPPORT</h2>
                    <p className="hover:text-fifth-color dark:hover:text-fifth-color text-base leading-4 mt-6 dark:text-seventh-color cursor-pointer">Legal policy</p>
                    <p className="hover:text-fifth-color dark:hover:text-fifth-color text-base leading-4 mt-6 dark:text-seventh-color cursor-pointer">Status policy</p>
                    <p className="hover:text-fifth-color dark:hover:text-fifth-color text-base leading-4 mt-6 dark:text-seventh-color cursor-pointer">Privacy policy</p>
                    <p className="hover:text-fifth-color dark:hover:text-fifth-color text-base leading-4 mt-6 dark:text-seventh-color cursor-pointer">Terms of service</p>
                </div>
                <div className="mt-10 lg:block hidden">
                    ...
                    <div className="cursor-pointer flex items-center justify-between border border-gray-800 mt-4">
                        <input type="text" className="text-base leading-4 p-4 w-full focus:outline-none text-seventh-color placeholder-gray-800" placeholder="Ingrese su email" />
